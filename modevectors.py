...
def modevectors(first_obj_frame, last_obj_frame, first_state=1, last_state=1, outname="modevectors", head=0.5, tail=0.1, head_length=0.3, headrgb="0.5,0.5,0.5", tailrgb="0.0,0.0,0.0", cutoff=4.0, skip=0, cut=0.5, atom="CA", stat="show", factor=1.0, notail=1):
    """
